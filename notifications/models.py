...
class LeadspaceBanner(models.Model):
    ...
    trust_tag1 = models.CharField(max_length=80, blank=True, default='925 Certified')
    trust_tag2 = models.CharField(max_length=80, blank=True, default='Free Shipping')
    trust_tag3 = models.CharField(max_length=80, blank=True, default='Easy Returns')
